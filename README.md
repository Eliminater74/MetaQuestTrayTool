...
**Latest:** [v1.1.21 — MetaQuestTrayTool-Setup-1.1.21.exe](https://github.com/Eliminater74/MetaQuestTrayTool/releases/download/v1.1.21/MetaQuestTrayTool-Setup-1.1.21.exe)
...
Release **[v1.1.21](https://github.com/Eliminater74/MetaQuestTrayTool/releases/latest)** is current — see **[CHANGELOG.md](CHANGELOG.md)** for every release. Single-instance startup protection, stale helper recovery, expanded headset TTS, safer profile/game launches, and experimental MSFS 2024 VR automation are included.
